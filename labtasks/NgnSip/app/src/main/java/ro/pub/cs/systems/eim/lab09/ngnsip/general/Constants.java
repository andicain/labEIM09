...
public interface Constants {
    ...
    final public static String USERNAME = "andrei";
    final public static String IDENTITY_IMPI = "ak97";
    final public static String IDENTITY_PASSWORD = "EWggRMydZT2et4xi";
    final public static String DOMAIN = "ak97.onsip.com";
    final public static String NETWORK_PCSCF_HOST = "sip.onsip.com";
    final public static int NETWORK_PCSCF_PORT = 5060;
    final public static String NETWORK_REALM = "ak97.onsip.com";
